...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div style="width:60%">
        {!! Form::model($expense, ['method' => 'PATCH','route' => ['admin.expense.update', $expense->id]]) !!}

        <div  class="form-group">
          {!! Form::label('title','Expense Title : ',['class' => 'control-label']) !!}
          {!! Form::text('title', $expense->title , ['placeholder' => 'Title','class'=>'form-control']) !!}
        </div>
        <div  class="form-group">

          {!! Form::label('expense_type','Expense Type : ',['class' => 'control-label']) !!}
          {!! Form::select('expense_type', $expense_types,$expense->type,['class'=>'form-control']) !!}
        </div>

        <div  class="form-group">
          {!! Form::label('amount','Expense Anount : ',['class' => 'control-label']) !!}
          {!! Form::number('amount', $expense->amount , ['placeholder' => 'Amount','class'=>'form-control']) !!}
        </div>

        <div  class="form-group">

          {!! Form::label('date','Date : ',['class' => 'control-label']) !!}
          {!! Form::date('date',$expense->date ,['class'=>'form-control']) !!}
        </div>


        <div  class="form-group">
          {!! Form::label('comments','Comments : ',['class' => 'control-label']) !!}
          {!! Form::textarea('comments', $expense->comments, ['placeholder' => 'Description','class'=>'form-control']) !!}
        </div>
